...
(defrule flooding-error(hydro-check 2) => (printout t "Unsuitable build site! Flooding or run-off in the area!" crlf))

(defrule erosion-error(hydro-check 3) => (printout t "Unsuitable build site! Land erosion likely" crlf))
...
(defrule low-energy (energy-check 3) => (printout t "Unsuitable build site! not profitable to build!" crlf))
...
(defrule high-wildlife(x ?x)(test (>= ?x 20)) => (printout t "Build site rejected! too much impact on wildlife!" crlf))
...
(defrule low-wildlife-loud-impact (sound-impact-check 2) => (printout t "Unsuitable build site! negative impact on population!" crlf))
...
(defrule Stable/partly-ground (geological-check 1) => (printout t "Build site Accepted as Second best option! Stabilise ground if survey says partly stable..." crlf))
...
(defrule rejected-geo (geo-ground-check 3) => (printout t "Build site Unsuitable! unstable ground!"))

(defrule geo-second-Best(geo-ground-check 2) => (printout t "Accepted as Second Best build site! Stabilise the land if needed... " crlf))

(defrule medium-energy-geo-check-output (and(geo-ground-check 1)(energy-check 2)) => (printout t "Accepted as second best build site due to medium energy production!" crlf))
(defrule geo-best (and(geo-ground-check 1)(energy-check 1)) => (printout t "Accepted as The Best Build site! start building ASAP!" crlf))
...
(defrule reject-loud-impact (sound-check 2) => (printout t "Unsuitable build site! negative impact on population!" crlf))
...
(defrule unstable-ground (medium-wildlife-geological-check 2) => (printout t "Unsuitable build site! ground is not stable! " crlf))
(defrule stable-ground (medium-wildlife-geological-check 1) => (printout t "Build site Accepted as Second best option! Stabilise land and create new wildlife habitats if required..." crlf))
